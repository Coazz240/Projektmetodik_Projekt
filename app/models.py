...
class EmissionFactor(Base):
    ...
    source: Mapped[Optional[str]] = mapped_column(String, nullable=False, default="course_default")
    scope: Mapped[str] = mapped_column(String(20), nullable=False, default="direct")
class Activity(Base):
